import 'package:breadpolitech/components/extensions/context_x.dart';
...
import 'package:breadpolitech/presentation/common/svg_objects.dart';
  ...
  void _onNextPageListener() {
    if (scrollController.offset >= scrollController.position.maxScrollExtent) {
      ...
      if (!bloc.state.isPaginationLoading) {
        bloc.add(
          HomeLoadDataEvent(search: searchController.text, nextPos: bloc.state.data?.nextPos),
        );
      }
    }
  }
